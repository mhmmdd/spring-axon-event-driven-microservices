...
Vagrant.configure("2") do |config|
  ...
  config.vm.network "forwarded_port", guest: 8024, host: 8024, disabled: false # axon ui
  config.vm.network "forwarded_port", guest: 8124, host: 8124, disabled: false # axon api
